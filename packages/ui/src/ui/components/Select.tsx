...
/*
 * Documentation:
 * Select — https://app.subframe.com/71d92cde7b25/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
...
const Trigger = React.forwardRef<HTMLElement, TriggerProps>(function Trigger(
  ...
  return (
    <SubframeCore.Select.Trigger asChild={true} {...otherProps}>
      ...
      >
        {icon ? (
          <span className="text-body font-body text-neutral-400">{icon}</span>
        ) : null}
