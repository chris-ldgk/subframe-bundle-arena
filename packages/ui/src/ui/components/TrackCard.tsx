...
/*
 * Documentation:
 * TrackCard — https://app.subframe.com/71d92cde7b25/library?component=TrackCard_8f3d5a24-7bf5-475f-9a1d-d280f9f14adb
 */
...
const TrackCardRoot = React.forwardRef<HTMLElement, TrackCardRootProps>(
  function TrackCardRoot(
    {
      title,
      artist,
      length,
    ...
    return (
      <div
        className={SubframeCore.twClassNames(
          "flex h-80 w-80 flex-col items-start gap-2 overflow-hidden rounded-md px-1 py-1 shadow-sm relative",
          className
        )}
        ref={ref as any}
        {...otherProps}
...
export const TrackCard = Object.assign(TrackCardRoot, {
  LengthBadge,
  FavoriteButton,
  GenreBadge,
});
