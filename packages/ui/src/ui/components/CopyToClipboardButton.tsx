...
/*
 * Documentation:
 * Copy to clipboard button — https://app.subframe.com/71d92cde7b25/library?component=Copy+to+clipboard+button_e8c76626-6462-4f2f-b595-38d530d427e8
 * Tooltip — https://app.subframe.com/71d92cde7b25/library?component=Tooltip_ccebd1e9-f6ac-4737-8376-0dfacd90c9f3
 */
      ...
      <SubframeCore.Tooltip.Root>
        <SubframeCore.Tooltip.Trigger asChild={true}>
          ...
          >
            ...
            >
              {icon ? (
                <span className="text-body font-body text-subtext-color group-hover/e8c76626:text-default-font">
                  {icon}
                </span>
              ) : null}
            </div>
